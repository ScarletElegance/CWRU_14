...
# NORMAL:0
for i in range(1, 3):
    params['data_path'] = 'D:/0bearing/data/train/NORMAL0' + str(i) + '.csv'
    params['opath'] = 'D:/0bearing/datafeature_600/NORMAL0' + str(i) + '_feature.csv'
...
# B:1
for i in range(1, 7):
    params['data_path'] = 'D:/0bearing/data/train/B0' + str(i) + '.csv'
    params['opath'] = 'D:/0bearing/datafeature_600/B0' + str(i) + '_feature.csv'
    fea = feature_get(params['data_path'], windowlen)
...
for i in range(1, 15):
    if (i <= 9):
        params['data_path'] = 'D:/0bearing/data/train/OR0' + str(i) + '.csv'
        params['opath'] = 'D:/0bearing/datafeature_600/OR0' + str(i) + '_feature.csv'
    else:
        params['data_path'] = 'D:/0bearing/data/train/OR' + str(i) + '.csv'
        params['opath'] = 'D:/0bearing/datafeature_600/OR' + str(i) + '_feature.csv'
    fea = feature_get(params['data_path'], windowlen)
    result = pd.DataFrame(fea, columns=columns_list_final1)
    result['label'] = 2
    result.to_csv(params['opath'], index=False, header=True)
...
# IR:3
for i in range(1, 7):
    params['data_path'] = 'D:/0bearing/data/train/IR0' + str(i) + '.csv'
    params['opath'] = 'D:/0bearing/datafeature_600/IR0' + str(i) + '_feature.csv'
    fea = feature_get(params['data_path'], windowlen)
    result = pd.DataFrame(fea, columns=columns_list_final1)
    result['label'] = 3
    result.to_csv(params['opath'], index=False, header=True)
