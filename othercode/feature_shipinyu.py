...
params = {}
params['path'] = 'D:/Bearing-fault-prediction-master/data/datapre/datapre_junheng/23/23.csv'
params['opath'] ='D:/Bearing-fault-prediction-master/data/datapre/datapre_junheng/23/23_shipinyu_3.csv'
params['len_piece']=20
params['wave_layer']=3
